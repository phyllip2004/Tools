...
@app.route('/api/v1/macd/get_phone', methods=['POST'])
def api_get_phone():
    payload="<soapenv:Envelope xmlns:soapenv=\"http://schemas.xmlsoap.org/soap/envelope/\" xmlns:ns=\"http://www.cisco.com/AXL/API/11.0\"><soapenv:Header/><soapenv:Body><ns:getPhone><name>sep000011112222</name></ns:getPhone></soapenv:Body></soapenv:Envelope>"
    headers = {
